        ...
        <div className="header-right">
          ...
          {showProfileDiv ? (
            <div className="profile-div">
              <p>
                <Link to="/signin">
                  <span className="login-signin-link">Sign In</span>
                </Link>
              </p>
            </div>
          ) : null}
          ...
          <div className="Bar">
            ...
            >
              ...
              <span className="add-guest-span">Add guests</span>
                ...
                <div className="search-icon" onClick={()=>{document.querySelector("form").submit()}}>
                <Link to={{pathname:'/search/page', aboutProps:{hotelID : 100, sdate : '13-11-2020' , edate:'15-11-2020'}}}><div className="search-icon"><SearchIcon/></div></Link>
                </div>  
            {/* {search ? <Redirect to='/search'></Redirect> : null} */}
          </div>
        </form>
        {showSearchSuggestions ? (
